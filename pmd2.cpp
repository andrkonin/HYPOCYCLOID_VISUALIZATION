...
void PMD2::deletemcircle()
{
    mcircle=!mcircle;
    updateGL();
}

void PMD2::deletescircle()
{
    scircle=!scircle;
    updateGL();
}

void PMD2::getData(float M_,float m1_,float m2_,float m3_,float m4_,float R_)
{
    M=M_;
    m1=m1_;
    m2=m2_;
...
void PMD2::resizeGL(int width,int height)
{
...
void PMD2::mousePressEvent(QMouseEvent *event)
{
...
void PMD2::mouseMoveEvent(QMouseEvent *event)
{
...
void PMD2::mouseDoubleClickEvent(QMouseEvent *event)
{
    stop=!stop;
}

void PMD2::wheelEvent(QWheelEvent *event)
{
...
int PMD2::faceAtPosition(const QPoint &pos)
{
